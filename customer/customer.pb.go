...
var file_customer_customer_proto_rawDesc = []byte{
	...
	0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x32, 0x8a, 0x02,
...
var file_customer_customer_proto_depIdxs = []int32{
	...
	5, // 6: customer.Customer.Add:output_type -> common.Response
	5, // 7: customer.Customer.Delete:output_type -> common.Response
	5, // 8: customer.Customer.Update:output_type -> common.Response
	5, // 9: customer.Customer.GetCustomer:output_type -> common.Response
	5, // 10: customer.Customer.GetList:output_type -> common.Response
