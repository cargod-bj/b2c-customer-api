...
type NotifyMeDTO struct {
	...
	BodyTypeId   string `protobuf:"bytes,13,opt,name=bodyTypeId,proto3" json:"bodyTypeId,omitempty"`
}
...
func (x *NotifyMeDTO) GetBodyTypeId() string {
	if x != nil {
		return x.BodyTypeId
	}
	return ""
...
var file_notifyMe_notifyMe_proto_rawDesc = []byte{
	...
	0x18, 0x0c, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x79, 0x65, 0x61, 0x72, 0x54, 0x6f, 0x12, 0x1e,
	0x0a, 0x0a, 0x62, 0x6f, 0x64, 0x79, 0x54, 0x79, 0x70, 0x65, 0x49, 0x64, 0x18, 0x0d, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0a, 0x62, 0x6f, 0x64, 0x79, 0x54, 0x79, 0x70, 0x65, 0x49, 0x64, 0x32, 0x3c,
