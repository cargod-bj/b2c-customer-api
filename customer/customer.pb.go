...
func (x *MarketingCondDto) GetCreateTime() uint64 {
	if x != nil {
		return x.CreateTime
	}
	return 0
...
var file_customer_customer_proto_rawDesc = []byte{
	...
	0x22, 0x62, 0x0a, 0x10, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x43, 0x6f, 0x6e,
	...
	0x72, 0x69, 0x66, 0x79, 0x12, 0x1e, 0x0a, 0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x69,
	0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x54, 0x69, 0x6d, 0x65, 0x32, 0xcc, 0x06, 0x0a, 0x08, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65,
...
var file_customer_customer_proto_depIdxs = []int32{
	...
	14, // 16: customer.Customer.Add:output_type -> common.Response
	14, // 17: customer.Customer.Delete:output_type -> common.Response
	14, // 18: customer.Customer.Update:output_type -> common.Response
	14, // 19: customer.Customer.GetCustomer:output_type -> common.Response
	14, // 20: customer.Customer.GetList:output_type -> common.Response
	14, // 21: customer.Customer.GetCustomerByCond:output_type -> common.Response
	14, // 22: customer.Customer.GetCustomerList:output_type -> common.Response
	14, // 23: customer.Customer.AssignCustomer:output_type -> common.Response
	14, // 24: customer.Customer.GetCustomerByContactNo:output_type -> common.Response
	14, // 25: customer.Customer.GetCustomerByIds:output_type -> common.Response
	14, // 26: customer.Customer.GetMail:output_type -> common.Response
	14, // 27: customer.Customer.GetC2BCustomerList:output_type -> common.Response
	14, // 28: customer.Customer.AddMarketVerifyData:output_type -> common.Response
	14, // 29: customer.Customer.ScheduleMarketingUser:output_type -> common.Response
