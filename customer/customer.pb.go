...
var file_customer_customer_proto_rawDesc = []byte{
	...
	0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x22, 0xf9, 0x01, 0x0a, 0x0b, 0x43, 0x75, 0x73,
	...
	0x6f, 0x72, 0x65, 0x49, 0x64, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x04, 0x52, 0x07, 0x73, 0x74, 0x6f,
	0x72, 0x65, 0x49, 0x64, 0x32, 0xc9, 0x04, 0x0a, 0x08, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65,
...
var file_customer_customer_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
...
var file_customer_customer_proto_depIdxs = []int32{
	...
	7,  // 5: customer.Customer.GetList:input_type -> customer.CustCondDto
	0,  // 6: customer.Customer.GetCustomerByCond:input_type -> customer.CustomerDTO
	5,  // 7: customer.Customer.GetCustomerList:input_type -> customer.IdListDto
	6,  // 8: customer.Customer.AssignCustomer:input_type -> customer.AssignDto
	7,  // 9: customer.Customer.GetCustomerByContactNo:input_type -> customer.CustCondDto
	4,  // 10: customer.Customer.GetCustomerByIds:input_type -> customer.IdList
	8,  // 11: customer.Customer.Add:output_type -> common.Response
	8,  // 12: customer.Customer.Delete:output_type -> common.Response
	8,  // 13: customer.Customer.Update:output_type -> common.Response
	8,  // 14: customer.Customer.GetCustomer:output_type -> common.Response
	8,  // 15: customer.Customer.GetList:output_type -> common.Response
	8,  // 16: customer.Customer.GetCustomerByCond:output_type -> common.Response
	8,  // 17: customer.Customer.GetCustomerList:output_type -> common.Response
	8,  // 18: customer.Customer.AssignCustomer:output_type -> common.Response
	8,  // 19: customer.Customer.GetCustomerByContactNo:output_type -> common.Response
	8,  // 20: customer.Customer.GetCustomerByIds:output_type -> common.Response
