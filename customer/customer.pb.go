...
var file_customer_customer_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x32, 0xd0, 0x01, 0x0a, 0x08, 0x43, 0x75,
...
var file_customer_customer_proto_depIdxs = []int32{
	...
	4, // 4: customer.Customer.GetList:input_type -> common.Page
	5, // 5: customer.Customer.Add:output_type -> common.Response
	5, // 6: customer.Customer.Delete:output_type -> common.Response
	5, // 7: customer.Customer.Update:output_type -> common.Response
	5, // 8: customer.Customer.GetList:output_type -> common.Response
