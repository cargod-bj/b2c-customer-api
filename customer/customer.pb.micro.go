...
type CustomerService interface {
	...
	GetCustomerPIC(ctx context.Context, in *CustomerDTO, opts ...client.CallOption) (*common.Response, error)
}
...
func (c *customerService) GetCustomerPIC(ctx context.Context, in *CustomerDTO, opts ...client.CallOption) (*common.Response, error) {
...
type CustomerHandler interface {
	...
	//通过门店和customerId获取人员的PIC
	GetCustomerPIC(context.Context, *CustomerDTO, *common.Response) error
}
...
func RegisterCustomerHandler(s server.Server, hdlr CustomerHandler, opts ...server.HandlerOption) error {
	type customer interface {
		...
		GetCustomerPIC(ctx context.Context, in *CustomerDTO, out *common.Response) error
	}
...
func (h *customerHandler) GetCustomerPIC(ctx context.Context, in *CustomerDTO, out *common.Response) error {
