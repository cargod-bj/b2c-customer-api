...
type MarketingRecordDto struct {
	...
	CustomerId         uint64 `protobuf:"varint,1,opt,name=customerId,proto3" json:"customerId,omitempty"`                 //customerId
	Verify             uint32 `protobuf:"varint,3,opt,name=verify,proto3" json:"verify,omitempty"`                         //是否通过验证
	Source             string `protobuf:"bytes,4,opt,name=source,proto3" json:"source,omitempty"`                          //客户来源
	CouponIssuanceTime uint64 `protobuf:"varint,5,opt,name=couponIssuanceTime,proto3" json:"couponIssuanceTime,omitempty"` //优惠券发放时间
}
...
func (x *MarketingRecordDto) GetVerify() uint32 {
	if x != nil {
		return x.Verify
	}
	return 0
...
var file_customer_customer_proto_rawDesc = []byte{
	...
	0x73, 0x6f, 0x6e, 0x6e, 0x65, 0x6c, 0x22, 0xd1, 0x01, 0x0a, 0x11, 0x43, 0x32, 0x42, 0x43, 0x75,
	...
	0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x74, 0x0a, 0x10, 0x4d, 0x61,
	...
	0x01, 0x28, 0x04, 0x52, 0x07, 0x64, 0x61, 0x74, 0x65, 0x45, 0x6e, 0x64, 0x22, 0x94, 0x01, 0x0a,
	0x12, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64,
	0x44, 0x74, 0x6f, 0x12, 0x1e, 0x0a, 0x0a, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x49,
