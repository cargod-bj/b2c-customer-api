...
var file_customer_customer_proto_rawDesc = []byte{
	...
	0x02, 0x69, 0x64, 0x22, 0x35, 0x0a, 0x09, 0x49, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x74, 0x6f,
	...
	0x04, 0x52, 0x07, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x49, 0x64, 0x22, 0x65, 0x0a, 0x09, 0x41, 0x73,
	...
	0x65, 0x22, 0xf9, 0x01, 0x0a, 0x0b, 0x43, 0x75, 0x73, 0x74, 0x43, 0x6f, 0x6e, 0x64, 0x44, 0x74,
	0x6f, 0x12, 0x16, 0x0a, 0x06, 0x70, 0x61, 0x67, 0x65, 0x4e, 0x6f, 0x18, 0x01, 0x20, 0x01, 0x28,
	...
	0x65, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x63, 0x74,
	0x4e, 0x6f, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x63,
	...
	0x07, 0x73, 0x74, 0x61, 0x66, 0x66, 0x49, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x04, 0x52, 0x07,
	0x73, 0x74, 0x61, 0x66, 0x66, 0x49, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x73, 0x74, 0x61, 0x66, 0x66,
	0x49, 0x64, 0x73, 0x18, 0x08, 0x20, 0x03, 0x28, 0x04, 0x52, 0x08, 0x73, 0x74, 0x61, 0x66, 0x66,
	0x49, 0x64, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x49, 0x64, 0x18, 0x0f,
	0x20, 0x01, 0x28, 0x04, 0x52, 0x07, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x49, 0x64, 0x32, 0x8f, 0x04,
...
var file_customer_customer_proto_goTypes = []interface{}{
	...
	(*AssignDto)(nil),       // 5: customer.AssignDto
	(*CustCondDto)(nil),     // 6: customer.CustCondDto
...
var file_customer_customer_proto_depIdxs = []int32{
	...
	6,  // 5: customer.Customer.GetList:input_type -> customer.CustCondDto
	...
	5,  // 8: customer.Customer.AssignCustomer:input_type -> customer.AssignDto
	6,  // 9: customer.Customer.GetCustomerByContactNo:input_type -> customer.CustCondDto
	7,  // 10: customer.Customer.Add:output_type -> common.Response
	7,  // 11: customer.Customer.Delete:output_type -> common.Response
	7,  // 12: customer.Customer.Update:output_type -> common.Response
	7,  // 13: customer.Customer.GetCustomer:output_type -> common.Response
	7,  // 14: customer.Customer.GetList:output_type -> common.Response
	7,  // 15: customer.Customer.GetCustomerByCond:output_type -> common.Response
	7,  // 16: customer.Customer.GetCustomerList:output_type -> common.Response
	7,  // 17: customer.Customer.AssignCustomer:output_type -> common.Response
	7,  // 18: customer.Customer.GetCustomerByContactNo:output_type -> common.Response
