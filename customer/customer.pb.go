...
var file_customer_customer_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x65, 0x49, 0x64, 0x32, 0xfc, 0x04, 0x0a, 0x08, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d,
...
var file_customer_customer_proto_depIdxs = []int32{
	...
	10, // 13: customer.Customer.Add:output_type -> common.Response
	10, // 14: customer.Customer.Delete:output_type -> common.Response
	10, // 15: customer.Customer.Update:output_type -> common.Response
	10, // 16: customer.Customer.GetCustomer:output_type -> common.Response
	10, // 17: customer.Customer.GetList:output_type -> common.Response
	10, // 18: customer.Customer.GetCustomerByCond:output_type -> common.Response
	10, // 19: customer.Customer.GetCustomerList:output_type -> common.Response
	10, // 20: customer.Customer.AssignCustomer:output_type -> common.Response
	10, // 21: customer.Customer.GetCustomerByContactNo:output_type -> common.Response
	10, // 22: customer.Customer.GetCustomerByIds:output_type -> common.Response
	10, // 23: customer.Customer.GetMail:output_type -> common.Response
