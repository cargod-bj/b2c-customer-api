...
type CustomerUpdateDto struct {
	...
	Email       string `protobuf:"bytes,4,opt,name=email,proto3" json:"email,omitempty"`
	SkipCollect uint64 `protobuf:"varint,3,opt,name=skipCollect,proto3" json:"skipCollect,omitempty"`
}
...
func (x *CustomerUpdateDto) GetSkipCollect() uint64 {
	if x != nil {
		return x.SkipCollect
	}
	return 0
...
var file_customer_customer_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x04, 0x52, 0x07, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x49, 0x64, 0x22, 0x77, 0x0a, 0x11,
	...
	0x61, 0x69, 0x6c, 0x12, 0x20, 0x0a, 0x0b, 0x73, 0x6b, 0x69, 0x70, 0x43, 0x6f, 0x6c, 0x6c, 0x65,
	0x63, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0b, 0x73, 0x6b, 0x69, 0x70, 0x43, 0x6f,
	0x6c, 0x6c, 0x65, 0x63, 0x74, 0x32, 0x80, 0x06, 0x0a, 0x08, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d,
