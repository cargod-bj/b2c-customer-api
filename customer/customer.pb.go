...
var file_customer_customer_proto_rawDesc = []byte{
	...
	0x32, 0x83, 0x06, 0x0a, 0x08, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x12, 0x30, 0x0a,
...
var file_customer_customer_proto_depIdxs = []int32{
	...
	13, // 15: customer.Customer.Add:output_type -> common.Response
	13, // 16: customer.Customer.Delete:output_type -> common.Response
	13, // 17: customer.Customer.Update:output_type -> common.Response
	13, // 18: customer.Customer.GetCustomer:output_type -> common.Response
	13, // 19: customer.Customer.GetList:output_type -> common.Response
	13, // 20: customer.Customer.GetCustomerByCond:output_type -> common.Response
	13, // 21: customer.Customer.GetCustomerList:output_type -> common.Response
	13, // 22: customer.Customer.AssignCustomer:output_type -> common.Response
	13, // 23: customer.Customer.GetCustomerByContactNo:output_type -> common.Response
	13, // 24: customer.Customer.GetCustomerByIds:output_type -> common.Response
	13, // 25: customer.Customer.GetMail:output_type -> common.Response
	13, // 26: customer.Customer.GetC2BCustomerList:output_type -> common.Response
	13, // 27: customer.Customer.AddMarketVerifyData:output_type -> common.Response
