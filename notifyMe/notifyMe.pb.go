...
type NotifyMeDTO struct {
	...
	Color        []uint64 `protobuf:"varint,2,rep,packed,name=color,proto3" json:"color,omitempty"`
	...
	ModelIds     []uint64 `protobuf:"varint,6,rep,packed,name=modelIds,proto3" json:"modelIds,omitempty"`
	...
	Transmission []uint64 `protobuf:"varint,10,rep,packed,name=transmission,proto3" json:"transmission,omitempty"`
...
func (x *NotifyMeDTO) GetColor() []uint64 {
	if x != nil {
		return x.Color
	}
	return nil
...
func (x *NotifyMeDTO) GetModelIds() []uint64 {
	if x != nil {
		return x.ModelIds
	}
	return nil
...
func (x *NotifyMeDTO) GetStoreIds() []uint64 {
	if x != nil {
		return x.StoreIds
	}
	return nil
...
func (x *NotifyMeDTO) GetTransmission() []uint64 {
	if x != nil {
...
var file_notifyMe_notifyMe_proto_rawDesc = []byte{
	...
	0x03, 0x28, 0x04, 0x52, 0x05, 0x63, 0x6f, 0x6c, 0x6f, 0x72, 0x12, 0x1a, 0x0a, 0x08, 0x6b, 0x65,
	...
	0x64, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x04, 0x52, 0x08, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x49,
	...
	0x6f, 0x72, 0x65, 0x49, 0x64, 0x73, 0x18, 0x09, 0x20, 0x03, 0x28, 0x04, 0x52, 0x08, 0x73, 0x74,
	0x6f, 0x72, 0x65, 0x49, 0x64, 0x73, 0x12, 0x22, 0x0a, 0x0c, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x6d,
	0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x04, 0x52, 0x0c, 0x74, 0x72,
